...
LootCouncilLocalization["BAD_CMD"] = "%s is not a valid command for /lc"
LootCouncilLocalization["BAD_GUILD_RANK"] = "You must select a valid guild rank"
LootCouncilLocalization["BAD_MANUAL_ADD"] = "Invalid Entry. Correct form: /lc add (charName) (itemLink)"
...
LootCouncilLocalization["CMD_PREFIX"] = "prefix: /lc"
...
LootCouncilLocalization["FAILED_START_NO_LINK"] = "Correct usage: /lc start (itemlink)"
...
LootCouncilLocalization["START_MSG_PULSE2"] = "If you want %s, link your current item in the appropriate channel."
...
LootCouncilLocalization["UPDATE_PROCESSED"] = "Recieved update in consideration for %s"
...
LootCouncilLocalization["UPDATE_PROCESSED_SPEC"] = "Recieved update in %s SPEC consideration for %s"
